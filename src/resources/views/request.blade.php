    ...
    <div class="unapproved-request">
        ...
        <table class="attendance-table">
            ...
            <tr>
                ...
                <td>{{ $unApprovedCorrection->attendance->date->format('Y/m/d') }}</td>
                <td>{{ $unApprovedCorrection->reason }}</td>
                <td>{{ $unApprovedCorrection->date->format('Y/m/d') }}</td>
                <td><a href="{{ route('admin.detail', $unApprovedCorrection->attendance_id) }}" class="detail-link">詳細</a></td>
            </tr>
            @endforeach
        </table>
        @endif
    ...
    <div class="approved-request">
        ...
        <table class="attendance-table">
            ...
            <tr>
                ...
                <td>{{ $approvedCorrection->attendance->date->format('Y/m/d') }}</td>
                <td>{{ $approvedCorrection->reason }}</td>
                <td>{{ $approvedCorrection->date->format('Y/m/d') }}</td>
                <td><a href="{{ route('admin.detail', $approvedCorrection->attendance_id) }}" class="detail-link">詳細</a></td>
            </tr>
            @endforeach
        </table>
        @endif
    ...
    <div class="unapproved-request">
        ...
        <table class="attendance-table">
            ...
            <tr>
                ...
                <td>{{ $unApprovedCorrection->reason }}</td>
                <td>{{ $unApprovedCorrection->date->format('Y/m/d') }}</td>
                <td><a href="{{ route('detail', $unApprovedCorrection->attendance_id) }}" class="detail-link">詳細</a></td>
            </tr>
            @endforeach
        </table>
        @endif
    ...
    <div class="approved-request">
        ...
        <table class="attendance-table">
            ...
            <tr>
                ...
                <td>{{ $approvedCorrection->reason }}</td>
                <td>{{ $approvedCorrection->date->format('Y/m/d') }}</td>
                <td><a href="{{ route('detail', $approvedCorrection->attendance_id) }}" class="detail-link">詳細</a></td>
            </tr>
            @endforeach
        </table>
        @endif
